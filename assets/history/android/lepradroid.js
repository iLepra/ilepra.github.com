{"history"  : [
  {
    "date" : "10 Мая 2012, версия 1.0.50",
    "changes" : "<ol><li>В пользовательские профили добавлен раздел 'Большой рассказ о себе'</li><li>Всю историю вы можете найти в 'История изменений' в настройках программы</li></ol>"
  },
  {
    "date" : "25 Апреля 2012, версия 1.0.39",
    "changes" : "<ol><li>Добавлена возможность добавлять/удалять посты в Избранное. Работает из меню на экране поста. Спасибо karamba за прекрасные картинки для меню</li><li>Разблокирована возможность добавлять/удалять инбоксы в мои вещи. На лепре такой функции нет, но здесь for fun решил оставить</li><li>Всю историю вы можете найти в 'История изменений' в настройках программы</li></ol>"
  },
  {
    "date" : "18 Апреля 2012, версия 1.0.34",
    "changes" : "<ol><li>[Тестовая фича] Теперь при нажатии на картинки, если не было других линков, открывается их источник в браузере, где их можно увеличить, сохранить и т.п. Так как при этом система может подумать, что у нее мало ресурсов и предыдущее приложение (LepraDroid) можно 'усыпить', то при таком переходе, возможно, назад уже будет не вернуться, т.к. откроется начальный экран</li><li>Всю историю вы можете найти в 'История изменений' в настройках программы</li></ol>"
  },
  {
    "date" : "17 Апреля 2012, версия 1.0.33",
    "changes" : "<ol><li>[Тестовая фича] Теперь при нажатии на картинки, если не было других линков, открывается их источник в браузере, где их можно увеличить, сохранить и т.п. Так как при этом система может подумать, что у нее мало ресурсов и предыдущее приложение (LepraDroid) можно 'усыпить', то при таком переходе, возможно, назад уже будет не вернуться, т.к. откроется начальный экран. Т.е. имеем <a href='https://github.com/NevRA/LepraDroid/issues/59'>https://github.com/NevRA/LepraDroid/issues/59</a></li></ol>"
  },
  {
