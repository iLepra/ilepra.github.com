...
(function($, window, document) {
	...
	_oExt.afnSortData['data-raw'] = function (oSettings, iColumn) {
		var aData = [];
	...
	_oExt.oStdClasses = {
		/* Two buttons buttons */
		"sPagePrevEnabled"  : "b-table-paginate__button_previous",
		"sPagePrevDisabled" : "b-table-paginate__button_disabled",
		"sPageNextEnabled"  : "b-table-paginate__button_next",
		"sPageNextDisabled" : "b-table-paginate__button_disabled",
		"sPageJUINext"      : "",
		"sPageJUIPrev"      : "",
		
		/* Full numbers paging buttons */
		"sPagesContainer"           : "b-table-paginate__pages",
		"sPageButton"               : "b-table-paginate__button",
		"sPageButtonActive"         : "b-table-paginate__button_active",
		"sPageButtonStaticDisabled" : "b-table-paginate__button_disabled",
		"sPageFirst"                : "b-table-paginate__button_first",
		"sPagePrevious"             : "b-table-paginate__button_previous",
		"sPageNext"                 : "b-table-paginate__button_next",
		"sPageLast"                 : "b-table-paginate__button_last",
		...
		/* Empty row */
		"sRowEmpty" : "b-table_empty",
		
		/* Features */
		"sPaging"     : "b-table-paginate b-table-paginate_type_",
		"sWrapper"    : "b-table__wrapper",
		"sFilter"     : "b-table__filter",
		"sInfo"       : "b-table__info",
		"sLength"     : "b-table__length",
		"sProcessing" : "b-table__processing",
	...
	_oExt.oPagination = {
		...
		"full_numbers": {
			"fnInit": function ( oSettings, nPaging, fnCallbackDraw ) {
				var iPagesCount = Math.ceil((oSettings.fnRecordsDisplay()) / oSettings._iDisplayLength);
				...
				var oClasses = oSettings.oClasses;
					...
					nList.className     = oClasses.sPagesContainer;
					nFirst.className    = oClasses.sPageFirst;
					nPrevious.className = oClasses.sPagePrevious;
					nNext.className     = oClasses.sPageNext;
					nLast.className     = oClasses.sPageLast;
			...
			"fnUpdate": function ( oSettings, fnCallbackDraw ) {
				...
				for ( i=0, iLen=an.length ; i<iLen ; i++ ) {
					...
					var qjPaginateList = $('span:eq(4)', an[i]);
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"oPaginate": {
					"sFirst":    "первая",
					"sPrevious": "<i class='b-table-paginate__arrow'>&larr;</i>предыдущая",
					"sNext":     "следующая<i class='b-table-paginate__arrow'>&rarr;</i>",
					"sLast":     "последняя"
				},
				"fnInfoCallback": null
			};
